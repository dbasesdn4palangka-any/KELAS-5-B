...
<div class="header-premium">
  <div class="title-emboss">ADMINISTRASI KELAS 5 B</div>
  <div class="subtitle-emboss">SDN 4 PALANGKA</div>
  <div class="text-white mt-2 small" style="opacity:0.8">GURU: <span id="guru-name">Yefri Haryanto</span></div>
</div>
...
function cetakPDF(tblId, judul, isWali=false){
   ...
   doc.setFontSize(10); doc.text("SDN 4 PALANGKA", 14, 22); doc.text(label, 14, 28);
